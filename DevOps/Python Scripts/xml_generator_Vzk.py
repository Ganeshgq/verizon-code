...
print ("Finding Class name from test case label...")
test_labels={}
...
for i in range(len(test_names)):
    ...
    #node1_2 = SubElement(child, "parameter", name="BrowserType1", value="IE")
    #node1_3 = SubElement(child, "parameter", name="BrowserType", value="firefox")
    node2 = SubElement(child, "classes")
    if test_labels[test_names[i]] == []:
        print ("Found a test case without label in JIRA. Please add class name as label.")
        sys.exit(1)
    elif test_labels[test_names[i]][0] == "End_User_Test":
        node3 = SubElement(node2, 'class', name="com.verizon.cao.selenium.End_User_Test."+class_names[i])
    elif test_labels[test_names[i]][0] == "Admin":
        node3 = SubElement(node2, 'class', name="com.verizon.cao.selenium.admin.test."+class_names[i])
    elif test_labels[test_names[i]][0] == "Authoring":
        node3 = SubElement(node2, 'class', name="com.verizon.cao.selenium.authoring.tests."+class_names[i])
    elif test_labels[test_names[i]][0] == "Extranet":
        node3 = SubElement(node2, 'class', name="com.verizon.cao.selenium.Extranet.tests."+class_names[i])
